pipeline {
  ...
  environment {
    ...
    EXT_USER = 'xemu-project'
    EXT_REPO = 'xemu'
    BUILD_VERSION_ARG = 'XEMU_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-xemu'
    CONTAINER_NAME = 'xemu'
    DOCKERHUB_IMAGE = 'linuxserver/xemu'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/xemu'
    PR_DOCKERHUB_IMAGE = 'lspipepr/xemu'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-xemu/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-xemu\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-xemu\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Xemu\" \
          --label \"org.opencontainers.image.description=[xemu](https://xemu.app/) is a free and open-source application that emulates the original Microsoft Xbox game console, enabling people to play their original Xbox games on Windows, macOS, and Linux systems.\" \
